...
var I18n = (function () {
  ...
  var _he = {
    ...
    'login.subtitle': 'הזן מספר ח.פ וסיסמה',
    ...
    'login.invalidCredentials': 'ח.פ או סיסמה שגויים',
    'login.authNetwork': 'שירות ההתחברות לא זמין כרגע. נסה שוב בעוד רגע.',
    'login.authServer': 'לא ניתן להתחבר כרגע. בדוק את החיבור ונסה שוב.',
    ...
    'success.bsd': 'בס״ד',
    'success.deliveryNoteNumbered': 'תעודת משלוח מספר ',
    'success.bizDetails': 'פרטי עסק',
    'success.clientSection': 'לקוח',
    'success.shipSection': 'משלוח',
    'success.shipAddressLabel': 'כתובת משלוח',
    'success.contactAndPhone': 'איש קשר יחי\'',
    'success.bizIdShort': 'ח.פ',
    'success.colSku': 'מק״ט',
    'success.colQty': 'כמות',
    'success.colLineGross': 'סה״כ',
    'success.colDiscPct': 'הנחה %',
    'success.colLineNet': 'סה״כ סופי',
    'success.grossTotal': 'סה״כ ברוטו',
    'success.totalDiscount': 'הנחה כוללת',
    'success.preVatTotal': 'סה״כ לפני מע״מ',
    'success.signatureRecipient': 'חתימת מקבל:',
    'success.bizPlaceholder': 'כאן חסר פרט — השלם בהגדרות המערכת',
    ...
    'sys.adminLoginFnMissing': 'שירות האימות לא זמין בשרת. וודא פריסת Cloud Functions.',
    'sys.adminLoginServer': 'שגיאת שרת באימות מנהל. נסה שוב מאוחר יותר.',
    'sys.adminLoginNetwork': 'בעיית חיבור לרשת. בדוק אינטרנט ונסה שוב.',
    'sys.adminLoginAuth': 'בעיה בהתחברות Firebase Auth. נסה לרענן את הדף.',
    'sys.adminLoginGeneric': 'לא ניתן להתחבר כמנהל. בדוק את הקונסול לפרטים.',
    ...
    'admin.passwordHint': 'חובה להגדיר סיסמה — הלקוח נכנס רק עם ח.פ וסיסמה.',
    ...
    'admin.logoUpload': 'לוגו להדפסה (תעודת משלוח)',
    'admin.logoHint': 'PNG / JPG — עד ~450KB. נשמר כ־Base64, במטמון app_logo ובענן (מנהל בלבד).',
    'admin.logoRemove': 'מחק לוגו',
    'admin.logoSaved': 'הלוגו נשמר',
    'admin.logoRemoved': 'הלוגו הוסר',
    'admin.logoNotImage': 'נא לבחור קובץ תמונה',
    'admin.logoTooLarge': 'הקובץ גדול מדי — דחוס או בחר תמונה קטנה יותר',
    'admin.logoReadError': 'שגיאה בקריאת הקובץ',
    'admin.bizAddress': 'כתובת עסק (מופיעה בתעודת משלוח)',
    'admin.bizPhone': 'טלפון עסק (תעודת משלוח)',
    'admin.bizEmail': 'אימייל עסק (תעודת משלוח)',
    'admin.bizTaxId': 'ח.פ העסק (להדפסה ולמסמכים)',
    'admin.bizTaxIdPh': 'מספר ח.פ בלבד',
  ...
  var _en = {
    ...
    'login.subtitle': 'Enter your business ID and password',
    ...
    'login.invalidCredentials': 'Business ID or password is wrong',
    'login.authNetwork': 'Login service is unavailable right now. Try again shortly.',
    'login.authServer': 'Could not sign in right now. Check your connection and try again.',
    ...
    'success.bsd': 'B"H',
    'success.deliveryNoteNumbered': 'Delivery note no. ',
    'success.bizDetails': 'Business details',
    'success.clientSection': 'Customer',
    'success.shipSection': 'Shipment',
    'success.shipAddressLabel': 'Shipping address',
    'success.contactAndPhone': 'Contact & phone',
    'success.bizIdShort': 'Business ID (ח.פ)',
    'success.colSku': 'SKU',
    'success.colQty': 'Qty',
    'success.colLineGross': 'Total',
    'success.colDiscPct': 'Disc. %',
    'success.colLineNet': 'Net line',
    'success.grossTotal': 'Gross total',
    'success.totalDiscount': 'Total discount',
    'success.preVatTotal': 'Total before VAT',
    'success.signatureRecipient': 'Recipient signature:',
    'success.bizPlaceholder': 'Missing — complete in system settings',
    ...
    'sys.adminLoginFnMissing': 'Auth service is not available on the server. Deploy Cloud Functions.',
    'sys.adminLoginServer': 'Server error during admin sign-in. Try again later.',
    'sys.adminLoginNetwork': 'Connection problem. Check your network and try again.',
    'sys.adminLoginAuth': 'Firebase Auth issue. Try refreshing the page.',
    'sys.adminLoginGeneric': 'Cannot sign in as admin. Check the browser console for details.',
    ...
    'admin.passwordHint': 'A password is required — customers sign in with ID and password only.',
    ...
    'admin.logoUpload': 'Print logo (delivery note)',
    'admin.logoHint': 'PNG / JPG — up to ~450KB. Stored as Base64, in app_logo cache & cloud (admin only).',
    'admin.logoRemove': 'Remove logo',
    'admin.logoSaved': 'Logo saved',
    'admin.logoRemoved': 'Logo removed',
    'admin.logoNotImage': 'Please choose an image file',
    'admin.logoTooLarge': 'File too large — compress or pick a smaller image',
    'admin.logoReadError': 'Could not read the file',
    'admin.bizAddress': 'Business address (on delivery note)',
    'admin.bizPhone': 'Business phone (delivery note)',
    'admin.bizEmail': 'Business email (delivery note)',
    'admin.bizTaxId': 'Business registration no. (ח.פ)',
    'admin.bizTaxIdPh': 'ח.פ number only',
